HistoryPage {
	...
	LeftMenu { id: leftMenu; onIndexChoosed(idx): { signalLessonContent.focusItem(idx) } }

	Rectangle {
		id: contentRect;
		height: signalLessonContent.contentHeight + 30;
		anchors.top: parent.top;
		...
		ContentColumn {
			...
			PageColumn {
				...
				CodeExample {
					...
					sourceFile: "code_samples/SignalHandling.qml";
				}
			}
			...
			PageColumn {
				...
				CodeExample {
					...
					sourceFile: "code_samples/SignalArgsHandling.qml";
				}
			}
